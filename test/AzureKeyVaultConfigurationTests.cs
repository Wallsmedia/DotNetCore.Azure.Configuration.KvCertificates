...
public partial class AzureKeyVaultConfigurationTests
{
    ...
    public void LoadsAllSecretsFromVaultIntoSection()
    {
        ...
        using (var provider = new AzureKvCertificatesConfigurationProvider(client.Object, secretClient.Object, options))
        {
            ...
            ClassicAssert.AreEqual(new[] { "secrets", "secrets" }, childKeys);
            ClassicAssert.AreEqual("{\"Pkcs12Base64\":\"Value1\",\"PemCertBase64\":null}", provider.Get("secrets:Certificate1"));
            ClassicAssert.AreEqual("{\"Pkcs12Base64\":\"Value2\",\"PemCertBase64\":null}", provider.Get("secrets:Certificate2"));
        }
    }
    ...
    public void DoesNotLoadFilteredItems()
    {
        ...
        using (var provider = new AzureKvCertificatesConfigurationProvider(client.Object, secretClient.Object, options))
        {
            ...
            // Assert
            var childKeys = provider.GetChildKeys(Enumerable.Empty<string>(), null).ToArray();
            ClassicAssert.AreEqual(new[] { "Certificate1" }, childKeys);
            ClassicAssert.AreEqual("{\"Pkcs12Base64\":\"Value1\",\"PemCertBase64\":null}", provider.Get("Certificate1"));
        }
    }
    ...
    public void DoesNotLoadFilteredAndRemapItems()
    {
        ...
        using (var provider = new AzureKvCertificatesConfigurationProvider(client.Object, secretClient.Object, options))
        {
            ...
            // Assert
            var childKeys = provider.GetChildKeys(Enumerable.Empty<string>(), null).ToArray();
            ClassicAssert.AreEqual(new[] { "CertificateMap" }, childKeys);
            ClassicAssert.AreEqual("{\"Pkcs12Base64\":\"Value1\",\"PemCertBase64\":null}", provider.Get("CertificateMap"));
        }
    }
    ...
    public void SupportsReload()
    {
        ...
        MockSetupUtils.SetClientMocks(client,
            secretClient,
            null,
            ("Certificate1", "Value1", enabled: true, updated));
        ...
        using (var provider = new AzureKvCertificatesConfigurationProvider(client.Object, secretClient.Object, options))
        {
            ...
            provider.Load();
            ClassicAssert.AreEqual("{\"Pkcs12Base64\":\"Value2\",\"PemCertBase64\":null}", provider.Get("Certificate1"));
        }
    }
    ...
    public async Task SupportsAutoReload()
    {
        ...
        using (var provider = new ReloadControlKeyVaultProvider(client.Object, secretClient.Object, options))
        {
            ...
            ClassicAssert.AreEqual("{\"Pkcs12Base64\":\"Value2\",\"PemCertBase64\":null}", provider.Get("Certificate1"));
            ClassicAssert.AreEqual(1, numOfTokensFired);
        }
    }
    ...
    public async Task DoesntReloadUnchanged()
    {
        ...
        using (var provider = new ReloadControlKeyVaultProvider(client.Object, secretClient.Object, options))
        {
            ...
            ClassicAssert.AreEqual("{\"Pkcs12Base64\":\"Value1\",\"PemCertBase64\":null}", provider.Get("Certificate1"));
            ClassicAssert.AreEqual(0, numOfTokensFired);
        }
    }
    ...
    public async Task SupportsReloadOnEnabledChange()
    {
        ...
        using (var provider = new ReloadControlKeyVaultProvider(client.Object, secretClient.Object, options))
        {
            ...
            ClassicAssert.AreEqual("{\"Pkcs12Base64\":\"Value2\",\"PemCertBase64\":null}", provider.Get("Certificate2"));
    ...
    public void ReplaceDoubleMinusInKeyName()
    {
        ...
        using (var provider = new AzureKvCertificatesConfigurationProvider(client.Object, secretClient.Object, options))
        {
            ...
            // Assert
            ClassicAssert.AreEqual("{\"Pkcs12Base64\":\"Value1\",\"PemCertBase64\":null}", provider.Get("Section:Certificate1"));
        }
    }
    ...
    public void LimitsMaxParallelism()
    {
        ...
        {
            ClassicAssert.AreEqual($"{{\"Pkcs12Base64\":\"{i}\",\"PemCertBase64\":null}}", provider.Get("Certificate" + i));
        }

        ClassicAssert.LessOrEqual(maxParallel, 32);
    }
    ...
    public void ConstructorThrowsForNullValueOfKeyVaultCertificateWithPolicyNameEncoder()
    {
        ...
        var options = new AzureKvCertificatesConfigurationOptions
        {
            VaultUri = new Uri("http://azure.com/keyvault/"),
            ConfigurationSectionPrefix = null,
            KeyVaultCertificateNameEncoder = null
        };
